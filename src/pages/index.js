...
const BlogIndex = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>
        List of resources to get started with quantum computing. Click any Learn
        resource for links to resource, along with exercise solutions and
        discussions. <i>Get Involved</i> section coming at some point in future.
      </p>
      <h2>Learn</h2>
      <p>
